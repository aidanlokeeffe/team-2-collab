class HClGas {
  ...
  // method determines if HCL particle reacts or collides with a NH3 particle. NH3Gas does not have a similar method because the reaction only needs to occur once.
